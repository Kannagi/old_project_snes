...
.MACRO PRINTF_FAST
	...
	sec
	sbc #64
	sta LKS_BUF_BG3+0+(2*\1),x
	
	lda 1+\1,y
	sec
	sbc #64
	sta LKS_BUF_BG3+2+(2*\1),x
	
	lda 2+\1,y
	sec
	sbc #64
	sta LKS_BUF_BG3+4+(2*\1),x
	
	lda 3+\1,y
	sec
	sbc #64
	sta LKS_BUF_BG3+6+(2*\1),x

	lda MEM_TEMP
	sta LKS_BUF_BG3+1+0+(2*\1),x
	sta LKS_BUF_BG3+1+2+(2*\1),x
	sta LKS_BUF_BG3+1+4+(2*\1),x
	sta LKS_BUF_BG3+1+6+(2*\1),x
